...
const createExtraTopListTemplate = () => {
...
const createExtraCommentedListTemplate = () => {
  return `<section class="films-list--extra">
...
const filmsElement = renderTemplate(createFilmsTemplate(), mainElement);
const filmListElement = renderTemplate(createFilmListTemplate(), filmsElement).querySelector(`.films-list__container`);
...
new Array(EXTRA_FILMS_COUNT)
  .fill(``)
  .forEach(() => render(extraTopListElement, createCardTemplate()));
new Array(EXTRA_FILMS_COUNT)
  .fill(``)
  .forEach(() => render(extraCommentedListElement, createCardTemplate()));
renderTemplate(createPopupFilmTemplate(), bodyElement);
