...
export const createFilmModalTemplate = (movie) => {
  const {poster, ageLimit, name, originalName, rating, director, release, duration, genres, description, isOnTheWatchlist, isAlredyWatched, isFavorite} = movie.movieInfo;
