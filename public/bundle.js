...
const createCommentMarkup = (commentData) => {
  ...
  const commentDate = moment__WEBPACK_IMPORTED_MODULE_3___default()(date).format(`YYYY/MM/DD HH:mm`);
...
const periodFilter = {
  ...
  'week': (item) => Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date(item.userInfo.watchingDate).getTime()).format(`YYYYMMDD`)) >= Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date()).format(`YYYYMMDD`) - 7),
  'month': (item) => Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date(item.userInfo.watchingDate).getTime()).format(`YYYYMM`)) === Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date()).format(`YYYYMM`)),
  'year': (item) => Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date(item.userInfo.watchingDate).getTime()).format(`YYYY`)) === Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date()).format(`YYYY`)),
};
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EXTRA_MOVIES_HEADINGS, EMOTIONS, DEFAULT_SORT_TYPE, FILM_DETAILS_TITLES, FilterType, DESCRIPTION_MAX_LENGTH, UserRank, HIDDEN_CLASS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class PageController {
  ...
  _renderMovieCard(movieData, container = this._mainMoviesComponent.getMoviesList()) {
    ...
    const movieController = new _controllers_movie__WEBPACK_IMPORTED_MODULE_5__["MovieController"](container, this._onDataChange, this._onViewChange, this._onCloseBigCard);
    const movieInstance = {
  ...
  _mainMoviesListInit() {
    ...
    const iterator = Object(_utils_common__WEBPACK_IMPORTED_MODULE_9__["getNextItemsIterator"])(moviesData, ADD_MOVIES_AMOUNT, this._renderedMoviesAmount);
...
fetch(`https://htmlacademy-es-10.appspot.com/cinemaddict/`, {method: `GET`, headers: {'Authorization': `Basic eo0w590ik29889a`}})
...
const generateComment = (commentId) => {
  return {
    ...
    date: new Date(Date.now() - Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getRandomBetween"])(0, 363333) * 60 * 60 * 1000).toISOString(),
...
const generateWatchingDate = () => new Date(`2020, 01, ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, 17)}`).toISOString();
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: capitalize, shuffleArray, getNextItemsIterator, formatTime, getRandomBetween, getRandomArrayItem, getUserRank */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
