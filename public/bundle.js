...
class MovieController {
  ...
  render(movieData, comments) {
    ...
    this._bigCardComponent.setOnDeleteCommentClickCallback((commentId) => {
      ...
      this._blockDeletedComment(commentId);
  ...
  _blockDeletedComment(id) {
    this._deletingCommentButton = this._bigCardComponent.getElement().querySelector(`.film-details__comment-delete[data-comment-id=\`${id}\`]`);
...
const api = new _api_index__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, authorizationCode);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: capitalize, getNextItemsIterator, formatTime, getUserRank */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
